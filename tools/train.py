...
def parse_args():
    ...
    # parser.add_argument('--config', help='train config file path', default='configs/biggan/biggan_r_ada_fp16_gamma3.3_metfaces_1024_b4x8.py')
    parser.add_argument('--config', help='train config file path', default='configs/biggan/biggan_torch-sn_tinyimagenet_128x128_b32x8_1500k.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models', default='logs_imagenet')
    parser.add_argument(
